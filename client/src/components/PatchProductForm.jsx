                ...
                <form onSubmit={handleSubmit} className="product-form">
                    <div className="form-row">
                        <label className="form-label" htmlFor="productname">
                            Product Name ({70 - formData.productname.length}/70
                            chars remaining)
                        </label>
                        <input
                    ...
                    <div className="form-row">
                        <label className="form-label" htmlFor="description">
                            Description ({70 - formData.description.length}/70
                            chars remaining)
                        </label>
                        <input
                    ...
                    <div className="form-row">
                        ...
                        >
                            ...
                            {500 - formData.extended_description.length}/500
                            chars remaining)
                        </label>
                        <input
                    ...
                    <div className="form-row">
                        <label className="form-label" htmlFor="starting_price">
                            Starting Price (can't be changed if any bids has
                            been placed)
                        </label>
                        <input
